...
sub new
{
    ...
    close ($fh);
    $self->{'primary_fields'} = [qw(source_id year type level review research_area jno pno jtitle jtitle_alt series doi title_main title_sub pubyear pub_status)];
    $self->{'xpath'} = {
        ...
        pub_status                 => '/mxd:ddf_doc/mxd:publication/*/@pub_status',
